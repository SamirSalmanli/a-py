...
def yukle():
    ...
    if daxil == 1: #Termuxu yeniliyir ve lazimi paketleri yukluyur
        ...
        time.sleep(0.5)
        os.system("cd $HOME && git clone https://github.com/OnlineHacKing/Metasploit_Termux && cd Metasploit_Termux && chmod +x metasploit.sh && bash metasploit.sh")
        time.sleep(0.5)
        ...
        time.sleep(0.5)
        os.system("cd $HOME && git clone https://github.com/thewhiteh4t/seeker")
        time.sleep(0.5)
        os.system("cd seeker")
        time.sleep(0.5)
        ...
        time.sleep(0.5)
        os.system("cd $HOME && git clone https://github.com/tchelospy/termux-ngrok.git")
        time.sleep(0.5)
        ...
        time.sleep(0.8)
        os.system("cd $HOME && git clone https://github.com/SamirSalmanli/tbombforazerbaijan")
        time.sleep(0.5)
        ...
        os.system("cd $HOME && git clone https://github.com/SamirSalmanli/a-py")
        os.system("clear")
        print(colorama.Fore.RESET)
        os.system("cd a-py")
        os.system("python a-py.py")
